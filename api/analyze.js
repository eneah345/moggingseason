module.exports = async function handler(req, res) {
  ...
  // Log whether keys exist (not the actual values)
  console.log("FACEPP_KEY exists:", !!process.env.FACEPP_KEY);
  console.log("FACEPP_SECRET exists:", !!process.env.FACEPP_SECRET);
  console.log("FACEPP_KEY length:", process.env.FACEPP_KEY?.length);
